			...
			<div class="mail-inner-content">
				...
				<div class="mail-body">
					<div class="body-title">
						...
						<p><span> <a href="{{route('profile',$userdata->user_unique)}}">{{ $userdata->FromName }}</span></a> Request For Join a group <span>    <a href="{{route('groups.index',$userdata->group_id)}}">{{$userdata->group_title}}</a></span></p>
					</div>
					<!--member-->
									...
									<ul class="list-profile" id="connect">
										<li class="mt-list-item">
											<div class="list-image">
												<img alt="image" class="img-thumbnail"  href="#" src="{{$userdata->propic}}">
												
											</div>
											<div class="list-text user-connection">
												<h3 class="list-text-title wordwap">
												<a href="{{route('profile',$userdata->user_unique)}}">{{ $userdata->FromName }}</a>
												</h3>
												<div class="user-btn-gorup">
													<a href="{{route('joingroup.status',['accept',$userdata->group_id,$userdata->requid,$userdata->token])}}" class="btn btn-primary">Accept</a>
													<a href="{{route('joingroup.status',['ignore',$userdata->group_id,$userdata->requid,$userdata->token])}}" class="btn btn-info">Decline</a>
												</div>
											</div>
										</li>
									</ul>
