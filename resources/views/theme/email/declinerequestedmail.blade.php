			...
			<div class="mail-inner-content">
				...
				<div class="mail-header">
					...
					<div class="mail-header-title" >
						<h1>Decline  Group Invitation</h1>
					</div>
				</div>
				<div class="mail-body">
					<div class="body-title">
						<h4>
						Dear <span>{{$decline->Name}}</span>,
						</h4>
						<p>Sorry Group admin<span> <a href="{{route('profile',$decline->user_unique)}}">{{ $decline->Fromname }}</span></a>has Decline your Group Invitation</p>
					</div>
					<!--member-->
									...
									<ul class="list-profile" id="connect">
										<li class="mt-list-item">
											<div class="list-image">
												<img alt="image" class="img-thumbnail"  href="#" src="{{$decline->groupImage}}">
											</div>
											<div class="list-text user-connection">
												<h3 class="list-text-title wordwap">
												<a href="{{route('groups.index',$decline->group_id)}}">{{ $decline->group_title }}</a>
												</h3>
											</div>
										</li>
									</ul>
