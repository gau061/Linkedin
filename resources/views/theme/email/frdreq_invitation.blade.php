			...
			<div class="mail-inner-content">
				...
				<div class="mail-body">
					<div class="body-title">
						<h4>
						Dear <span>{{$user->sname}}</span>,
						</h4>
						<p><span> <a href="{{route('profile',$user->user_id)}}">{{$user->rname}}</span></a> has sent you  Friend Request</p>
					</div>
					<!--member-->
									...
									<ul class="list-profile" id="connect">
										<li class="mt-list-item">
											<div class="list-image">
												<img alt="image" class="img-thumbnail"  href="#" src="{{$user->propic}}">
											</div>
											<div class="list-text user-connection">
												<h3 class="list-text-title wordwap">
												<a href="{{route('profile',$user->user_id)}}">{{ $user->rname }}</a>
												</h3>
												<div class="user-btn-gorup">
													 <a href="{{ route('request.status',['ignore',$user->uid]) }}" class="btn btn-info">@lang('words.msg_acp.text_3')</a>
                                                                &nbsp;&nbsp;&nbsp;
                                                    <a href="{{ route('request.status',['accept',$user->uid]) }}" class="btn btn-primary">@lang('words.msg_acp.text_4')</a>
												</div>
											</div>
										</li>
									</ul>
