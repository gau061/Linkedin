			...
			<div class="mail-inner-content">
				...
				<div class="mail-header">
					...
					<div class="mail-header-title" >
						<h1> Decline Your  Group Invitation </h1>
					</div>
				</div>
				<div class="mail-body">
					<div class="body-title">
						<h4>
						Dear <span>{{$admin->sendername}}</span>,
						</h4>
						<p>Sorry <span> <a href="{{route('profile',$admin->touserid)}}">{{ $admin->fromname }}</span></a>  Decline Your  Group Request .</p>
					</div>
					<!--member-->
								...
								<ul class="list-profile" id="connect">
									<li class="mt-list-item">
										<div class="list-image">
											<img alt="image" class="img-thumbnail"  href="#" src="{{$admin->gimg}}">
										</div>
										<div class="list-text decline-connection">
											<h3 class="list-text-title wordwap">
											<a href="{{route('groups.index',$admin->gid)}}">{{ $admin->gtitle }}</a>
										</h3>											</div>
									</li>
								</ul>
							</div>
