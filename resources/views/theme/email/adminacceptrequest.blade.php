			...
			<div class="mail-inner-content">
				...
				<div class="mail-body">
					<div class="body-title">
						...
						<p>Congratulation Group Admin <span> <a href="{{route('profile',$user->user_unique)}}">{{ $user->toname }}</span></a> has Accept your Request</p>
					</div>
					<!--member-->
									...
									<ul class="list-profile" id="connect">
										<li class="mt-list-item">
											<div class="list-image">
												<img alt="image" class="img-thumbnail"  href="#" src="{{$user->groupImage}}">
											</div>
											<div class="list-text user-connection">
												<h3 class="list-text-title wordwap">
												<a href="{{route('groups.index',$user->group_id)}}">{{ $user->group_title }}</a>
												</h3>
											</div>
										</li>
									</ul>
