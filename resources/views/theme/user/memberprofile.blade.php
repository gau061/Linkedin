                    ...
                    <div class="row">
                        <div class="col-md-12 user-pro-respo">
                                        ...
                                        <div class="text">
                                            ...
                                            @if(auth()->guard('frontuser')->user()->unique_id != $data->unique_id)
                                                @if(! is_null($status))
                                                    ...
                                                    @else
                                                        <a href="javascript:void(0)" class="btn btn-primary msg-btn-ac msg-btn msg-cncel" data-url="{{ route('request.send',['cancel',$data->id]) }}" >@lang('words.request_cancel.text_2')</a>
                                                    @endif
                            ...
                            <ul class="cover-nav">
                                ...
                                <li><a href="{{ route('timeline.index',$data->unique_id) }}"><i class="fa fa-fw fa-bars"></i> @lang('words.pro_menu.tab_2')</a></li>
                                <li><a href="{{ route('connection.list') }}"><i class="fa fa-fw fa-users"></i> @lang('words.pro_menu.tab_3')</a></li>
                                
                                @if(auth()->guard('frontuser')->user()->unique_id == $data->unique_id)
                                <li class=" active pro-tab"><a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-fw fa-edit"></i> @lang('words.pro_menu.tab_4')</a></li>
