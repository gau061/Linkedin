...
<div class="box box-primary">
            ...
            {!! Form::open(['route'=>'industry.insert','method'=> 'post']) !!}
              <div class="box-body">
                  <div class="form-group col-md-12">
                    <label for="title">Title :</label>
                    {!! Form::text('industry_name','',['class'=>'form-control','id'=>'title','placeholder'=>'Enter Industry Name']) !!}
                    @if ($errors->has('industry_name')) <font color="red">{{ $errors->first('industry_name') }}</font> @endif 
                  </div>

                     <div class="form-group col-md-12">
                        <label for="description">Description :</label>
                        {!! Form::textarea('industry_desc','',['placeholder'=>'Enter Your  description','id'=>'description','class'=> 'form-control summernote']) !!}
